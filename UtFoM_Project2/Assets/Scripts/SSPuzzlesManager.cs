...
public class SSPuzzlesManager : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        {
            case 1:
                if (CompletedIDs.Contains(1003))
                {
                    SpriteRendererScript.sprite = SSMapList[1];
                }
                else if (CompletedIDs.Contains(1004))
                {
                    SpriteRendererScript.sprite = SSMapList[2];
                }
                else if (CompletedIDs.Contains(1005))
                {
                ...
                break;
            case 2:
                if (CompletedIDs.Contains(1003) && CompletedIDs.Contains(1004))
                {
                    SpriteRendererScript.sprite = SSMapList[5];
                }
                else if (CompletedIDs.Contains(1003) && CompletedIDs.Contains(1005))
                {
                    SpriteRendererScript.sprite = SSMapList[6];
                }
                else if (CompletedIDs.Contains(1004) && CompletedIDs.Contains(1005))
                {
                    SpriteRendererScript.sprite = SSMapList[7];
                }
                else if (CompletedIDs.Contains(1004) && CompletedIDs.Contains(1006))
                {
                    SpriteRendererScript.sprite = SSMapList[8];
                }
                else if (CompletedIDs.Contains(1005) && CompletedIDs.Contains(1006))
                {
                    SpriteRendererScript.sprite = SSMapList[9];
                }
                else if (CompletedIDs.Contains(1003) && CompletedIDs.Contains(1006))
                {
            ...
            case 3:
                ...
                else if (!CompletedIDs.Contains(1003))
                {
